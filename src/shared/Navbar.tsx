...
import { Menu, X, User, LogOut, CircleArrowOutUpRight, Settings, Wrench, Star, Info, CalendarDays, Briefcase, LayoutDashboard, Users, BarChart2 } from 'lucide-react';
...
const Navbar = ({ user }: NavbarProps) => {
    ...
    return (
        <nav className="sticky top-3 z-50 bg-accent backdrop-blur border-b border-border rounded-3xl mx-2 mt-3">
